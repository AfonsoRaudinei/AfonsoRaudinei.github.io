...
import { ArrowLeft, Beaker, Leaf, RefreshCw, Dna, Zap, AlertTriangle, BarChart3, Lightbulb } from "lucide-react";
      ...
      <div className="container mx-auto max-w-6xl px-4 py-8">
        ...
        <section className="bg-card/95 backdrop-blur-sm rounded-2xl p-6 mb-6 shadow-sm border border-border/50 animate-fade-up">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {fontesNitrogenio.map((fonte, index) => (
              <div
                key={fonte.nome}
        ...
        <section className="bg-card/95 backdrop-blur-sm rounded-2xl p-6 mb-6 shadow-sm border border-border/50 animate-fade-up">
          ...
          <div className="bg-card rounded-xl p-6 border border-border/50 mb-5">
            {cicloProcessos.map((processo, index) => (
              <div
                key={processo.titulo}
        ...
        <section className="bg-card/95 backdrop-blur-sm rounded-2xl p-6 mb-6 shadow-sm border border-border/50 animate-fade-up">
          ...
          <div className="relative pl-10">
            ...
            {timelineMetabolismo.map((item, index) => (
        ...
        <section className="bg-card/95 backdrop-blur-sm rounded-2xl p-6 mb-6 shadow-sm border border-border/50 animate-fade-up">
          ...
          <div className="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-xl p-5">
            {sintomasDeficiencia.map((sintoma, index) => (
              <div
                key={sintoma.titulo}
        ...
        <section className="bg-card/95 backdrop-blur-sm rounded-2xl p-6 mb-6 shadow-sm border border-border/50 animate-fade-up">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {teoresAdequados.map((teor, index) => (
              <div
                key={teor.cultura}
                className="p-6 rounded-xl bg-card border-2 border-blue-500 text-center shadow-sm"
              >
                <h3 className="text-lg font-semibold text-foreground mb-3">{teor.cultura}</h3>
                <p className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">{teor.valor}</p>
                <p className="text-sm text-muted-foreground">{teor.unidade}</p>
                <p className="text-xs text-muted-foreground mt-3">{teor.local}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-card/95 backdrop-blur-sm rounded-2xl p-6 mb-6 shadow-sm border border-border/50 animate-fade-up">
          ...
          <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 rounded-xl p-5">
            ...
            <ul className="space-y-3">
              {manejoRecomendacoes.map((rec, index) => (
                <li
                  key={rec.titulo}
        ...
        {/* Footer */}
        <footer className="bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-2xl p-8 text-center">
          <p className="text-zinc-400 text-sm mb-2">Nutrição de Plantas - Soja e Milho</p>
          <h3 className="text-white font-semibold text-lg mb-3">Raudinei Afonso</h3>
